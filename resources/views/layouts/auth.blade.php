...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark scheme-only-dark">
    ...
    <body class="min-h-dvh antialiased font-sans text-stone-100 bg-stone-950">
        ...
        <div class="relative isolate min-h-dvh overflow-hidden bg-stone-950 flex flex-col">
            ...
            {{-- Logo --}}
            <div class="relative z-10 flex-1 flex flex-col items-center justify-end text-center px-6 pt-12 pb-2">
            ...
            {{-- Form (no card) --}}
            <div class="relative z-10 mt-auto px-7 pb-10 pt-4">
                <h2 class="font-serif-display text-center text-4xl text-stone-50 leading-tight mb-1">
                    Prends ta place <em class="text-amber-200">autour du feu</em>
                </h2>
                <p class="text-center text-sm text-stone-300 mb-7 text-pretty">
